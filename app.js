...
async function start(){
    ...
    myTeamHTML = eval('`'+ mainHTML +'`');

    // write file to new team.html file
    fs.writeFile("output/team.html", myTeamHTML, function(err) {
...
start();
            ...
            // devMembers.push(manager);
            // idArrray.push(answers.managerId);
            // devTeam();       
